...
call "%PREFIX%\Scripts\conda.exe" install -y "%PREFIX%\pkgs\pyshp-PYSHPVERSION.tar.bz2" "%PREFIX%\pkgs\alabaster-ALABASTERVERSION.tar.bz2" "%PREFIX%\pkgs\dask-DASKVERSION.tar.bz2" -n root || ECHO ""
